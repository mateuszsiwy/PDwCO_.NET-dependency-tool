    ...
    <div className="container">
      ...
      <main className="main">
        ...
        <div className="graph-info">
          <p>
            <strong>{allNodes.filter(n => !n.id.includes('_')).length}</strong> Libraries • 
            <strong>{allNodes.filter(n => n.id.startsWith('cat_')).length}</strong> Categories • 
            <strong>{allNodes.filter(n => n.id.startsWith('fw_')).length}</strong> Frameworks • 
            <strong>{allNodes.filter(n => n.id.startsWith('auth_')).length}</strong> Authors
          </p>
        </div>

        <div ref={containerRef} className="graph-container" style={{ height: '70vh', border: '1px solid #333', borderRadius: '8px' }} />

        <div className="legend">
          <h3>Legend</h3>
          <div className="legend-items">
            <div className="legend-item">
              <div className="legend-box library"></div>
              <span>Library</span>
            </div>
            <div className="legend-item">
              <div className="legend-box category"></div>
              <span>Category</span>
            </div>
            <div className="legend-item">
              <div className="legend-box framework"></div>
              <span>Framework</span>
            </div>
            <div className="legend-item">
              <div className="legend-box author"></div>
              <span>Author</span>
            </div>
          </div>
          <div className="legend-relationships">
            <p><strong>depends on</strong> - Solid line</p>
            <p><strong>belongs to</strong> - Dashed line (category)</p>
            <p><strong>targets</strong> - Dashed line (framework)</p>
            <p><strong>maintained by</strong> - Dotted line</p>
            <p><strong>alternative</strong> - Long dashed bidirectional</p>
          </div>
        </div>
      </main>
    </div>
